...
pub(crate) fn action_deploy_contract(
    ...
    let prev_code = get_code(state_update, account_id.clone(), account.code_hash())?;
...
pub(crate) fn action_delete_account(
    ...
    if current_protocol_version >= ProtocolFeature::DeleteActionRestriction.protocol_version() {
        ...
        let contract_code = get_code(state_update, account_id.clone(), account.code_hash())?;
    ...
    remove_account(state_update, account_id, code_hash)?;
